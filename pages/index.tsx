...
export const Banner = ({ purpose, title1, title2, desc1, desc2, buttonText, linkName, imageUrl } : any ) => (
  <Flex flexWrap='wrap' justifyContent='center' alignItems='center' m='10'>
    <Image src={imageUrl} width={500} height={300} alt="Picture of the luxury"/>
    <Box p='5'>
